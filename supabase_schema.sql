...
-- ذخیره کلکسیون‌های عمومی: settings, research, research_history, discussion_groups, ...
-- ==============================================================================
...
-- اجازه دسترسی کامل برای کلاینت برنامه با کلید Anon / Authenticated
-- ==============================================================================
DO $$
DECLARE
  tbl text;
